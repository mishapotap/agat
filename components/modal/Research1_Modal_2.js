            ...
            <View style={styles.centeredView}>
                ...
                <ScrollView showsVerticalScrollIndicator={false} style={{width: 580}}>
                    <View style={styles.header}>
                        <View style={{alignSelf: 'center'}}><Research_1_Icon2_big/></View>
                        <Text style={flattenStyles.title}>Космическая биология{"\n"}и биотехнология</Text>
                    </View>
