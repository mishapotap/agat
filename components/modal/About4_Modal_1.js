...
import { Modal, StyleSheet, Text, Pressable, View, SafeAreaView, ScrollView, Image, StatusBar } from "react-native";
import { COLORS, FONTS } from "../../constants";
import {about_4_modal} from '../../constants/images';
import { Modal_CloseButton } from "../../assets/svg";

const About4_Modal_1 = ({modalVisible, setModalVisible}) => {
    return (
        <Modal
            ...
            <View style={styles.centeredView}>
                ...
                <ScrollView showsVerticalScrollIndicator={false} style={{width: '80%'}}>
                    <View style={styles.header}>
                        <Text style={flattenStyles.title}>Ценности космических исследований и экспериментов</Text>
                    </View>
                    <View style={{alignSelf: 'center'}}>
                        <Text style={flattenStyles.middle}>Космические исследования и эксперименты проводятся на Международной космической станции (МКС).</Text>
                        ...
                        <Text style={flattenStyles.middle}>На Российском сегменте МКС (РС МКС) проводятся исследования по следующим направлениям:</Text>
                        <View style={{marginBottom: 24}}>
                            <Text style={FONTS.modalList}>{'\u2022'}  Исследование Земли и космоса</Text>
                            <Text style={FONTS.modalList}>{'\u2022'}  Космическая биология и биотехнология</Text>
                            <Text style={FONTS.modalList}>{'\u2022'}  Физико-химические процессыи материалы в условиях космоса</Text>
                            <Text style={FONTS.modalList}>{'\u2022'}  Человек в космосе</Text>
                            <Text style={FONTS.modalList}>{'\u2022'}  Технологии освоения космического пространства</Text>
                            <Text style={FONTS.modalList}>{'\u2022'}  Образование и популяризация космических исследований</Text>
                        </View>
                        <Text style={flattenStyles.middle}>Результаты космических исследований на МКС имеют ценность</Text>
